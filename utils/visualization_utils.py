...
#  padding = int(20)
  ...
  right = right
  bottom = bottom
  #cv2.rectangle(image,(int(left)-padding,int(top)-padding),(int(right)+padding,int(bottom)+padding),(255,0,0),2)
  cv2.rectangle(image,(int(left),int(top)),(int(right),int(bottom)),(0,255,0),2)
  # cv2.imwrite("/mnt/efs/img.png", image)
...
def visualize_boxes_and_labels_on_image_array(image,
  ...
  if len(box_to_color_map) == 1:
      for box, color in box_to_color_map.items():
        ...
        coord = draw_bounding_box_on_image_array(
            image,
            ymin,
            xmin,
            ymax,
